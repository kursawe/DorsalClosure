#ifndef FIONAVORONOIVERTEXMESHGENERATOR_HPP_
#define FIONAVORONOIVERTEXMESHGENERATOR_HPP_
 ...
 */
class FionaVoronoiVertexMeshGenerator
{
...
public:
     ...
     */
    FionaVoronoiVertexMeshGenerator(unsigned numElementsX,
     ...
     */
    FionaVoronoiVertexMeshGenerator()
    {
    }
     ...
     */
    virtual ~FionaVoronoiVertexMeshGenerator();
...
#endif /*FIONAVORONOIVERTEXMESHGENERATOR_HPP_*/