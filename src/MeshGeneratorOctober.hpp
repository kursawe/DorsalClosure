#ifndef MESHGENERATOROCTOBER_HPP_
#define MESHGENERATOROCTOBER_HPP_
...
protected:
    ...
    /** The total number of histoblast rows on the bottom. */
    unsigned mNumHbRows;
    ...
    /** The length of a histoblast */
    double hb_edge_length; 

    /** The scaled width of a LEC compares to a histoblast */
    double lec_scale_hb_width;

    /** The short edge of a LEC compares */
    double lec_edge_length;

    /** The long edge scale of a LEC compared to short edge */
    double lec_scaled_height;

    /** The initial position that LECs start */
    double initial_lec_height;

    /** The initial position that the second row of hbs start */
    double initial_hb_height;

    /** Scaling factor */
    double scale_factor;

    /** Desired area multiplier */
...
public:
     ...
     * @param numHbRows     The number of histoblast rows on the bottom of the mesh 
     ...
     */
    MeshGeneratorOctober(unsigned numElementsX,
...
#endif /*MESHGENERATOROCTOBER_HPP_*/