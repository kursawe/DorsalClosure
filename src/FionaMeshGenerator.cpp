#include "FionaMeshGenerator.hpp"
#include "Debug.hpp"
...
FionaMeshGenerator::FionaMeshGenerator(unsigned numElementsX,
...
/////////////////////////////////////////////////////
void FionaMeshGenerator::ValidateInputAndSetMembers()
...
/////////////////////////////////////////////////////
void FionaMeshGenerator::GenerateVoronoiMesh()
...
/////////////////////////////////////////////////////
std::vector<c_vector<double, 2> > FionaMeshGenerator::GetInitialPointLocations()
...
/////////////////////////////////////////////////////
void FionaMeshGenerator::ValidateSeedLocations(std::vector<c_vector<double, 2> >& rSeedLocations)
...
/////////////////////////////////////////////////////
void FionaMeshGenerator::CreateVoronoiTessellation(std::vector<c_vector<double, 2> >& rSeedLocations)
...
MutableVertexMesh<2,2>* FionaMeshGenerator::GetMesh()
{//A pointer to a 2D mutable vertex mesh
    return mpMesh;
}

 MutableVertexMesh<2,2>* FionaMeshGenerator::GetMeshAfterReMesh()
 {//A pointer to a 2D mutable vertex mesh, after ReMesh() has been called to remove short edges
     mpMesh->ReMesh();
     return mpMesh;   
}

Toroidal2dVertexMesh* FionaMeshGenerator::GetToroidalMesh()
...
std::vector<c_vector<double, 2> > FionaMeshGenerator::GetElementCentroidsFromMesh()
...
FionaMeshGenerator::~FionaMeshGenerator()
...
bool FionaMeshGenerator::CheckForCongruentNodes(MutableVertexMesh<2,2>* pMesh, double width, double height)
...
std::vector<double> FionaMeshGenerator::GetPolygonDistribution()
...
double FionaMeshGenerator::GetAreaCoefficientOfVariation()
...
void FionaMeshGenerator::RefreshSeedsAndRegenerateMesh()
...
void FionaMeshGenerator::SetMaxExpectedNumSidesPerPolygon(unsigned maxExpectedNumSidesPerPolygon)
{//Set mMaxNumSidesPerPolygon.
    
    mMaxExpectedNumSidesPerPolygon = maxExpectedNumSidesPerPolygon;
}

unsigned FionaMeshGenerator::GetMaxExpectedNumSidesPerPolygon()
 ...
 */
FionaMeshGenerator::MyVoronoiVertexMeshGenerator()
{
