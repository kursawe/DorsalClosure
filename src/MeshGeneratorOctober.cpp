#include "MeshGeneratorOctober.hpp"
#include "Debug.hpp"
...
MeshGeneratorOctober::MeshGeneratorOctober(unsigned numElementsX,
...
/////////////////////////////////////////////////////
void MeshGeneratorOctober::ValidateInputAndSetMembers()
{ //Helper method for the constructor. Validates the input parameters, and sets up remaining member variables.
    ...
    initial_lec_height = (hb_edge_length + (3.0/2.0)*hb_edge_length*(mNumHbRows - 1.0)) + 0*hb_edge_length/2.0 + lec_scaled_height*lec_edge_length;
    ...
    initial_hb_height = initial_lec_height + (3.0/2.0)*lec_scaled_height*lec_edge_length*(mNumElementsY - 2.0*mNumHbRows - 1.0) + 0*hb_edge_length/2.0 + lec_scaled_height*lec_edge_length;
...
/////////////////////////////////////////////////////
void MeshGeneratorOctober::GenerateVoronoiMesh()
...
/////////////////////////////////////////////////////
std::vector<c_vector<double, 2> > MeshGeneratorOctober::GetInitialPointLocations()
                ...
                if (point_idx_y == (mNumElementsY - mNumHbRows))
                {
                   // if (point_idx_x%5 == 2 || point_idx_x%5 == 3 || point_idx_x%5 ==4)
                    if (point_idx_x%5 == 0 || point_idx_x%5 == 1 || point_idx_x%5 ==4)
                    {
                        ...
                        seed_points[point_idx][1] = (initial_hb_height + (3.0*hb_edge_length/2.0)*(point_idx_y - mNumElementsY + mNumHbRows-node_adjustment))*mMultiplierInY; ;
                        point_idx += 1;
                    }
                }
            }
...
/////////////////////////////////////////////////////
void MeshGeneratorOctober::ValidateSeedLocations(std::vector<c_vector<double, 2> >& rSeedLocations)
...
/////////////////////////////////////////////////////
void MeshGeneratorOctober::CreateVoronoiTessellation(std::vector<c_vector<double, 2> >& rSeedLocations)
...
MutableVertexMesh<2,2>* MeshGeneratorOctober::GetMesh()
{//A pointer to a 2D mutable vertex mesh
    return mpMesh;
}

 MutableVertexMesh<2,2>* MeshGeneratorOctober::GetMeshAfterReMesh()
 {//A pointer to a 2D mutable vertex mesh, after ReMesh() has been called to remove short edges
     mpMesh->ReMesh();
     return mpMesh;   
}

Toroidal2dVertexMesh* MeshGeneratorOctober::GetToroidalMesh()
...
std::vector<c_vector<double, 2> > MeshGeneratorOctober::GetElementCentroidsFromMesh()
...
MeshGeneratorOctober::~MeshGeneratorOctober()
...
bool MeshGeneratorOctober::CheckForCongruentNodes(MutableVertexMesh<2,2>* pMesh, double width, double height)
...
std::vector<double> MeshGeneratorOctober::GetPolygonDistribution()
...
double MeshGeneratorOctober::GetAreaCoefficientOfVariation()
...
void MeshGeneratorOctober::RefreshSeedsAndRegenerateMesh()
...
void MeshGeneratorOctober::SetMaxExpectedNumSidesPerPolygon(unsigned maxExpectedNumSidesPerPolygon)
{//Set mMaxNumSidesPerPolygon.
    
    mMaxExpectedNumSidesPerPolygon = maxExpectedNumSidesPerPolygon;
}

unsigned MeshGeneratorOctober::GetMaxExpectedNumSidesPerPolygon()
 ...
 */
MeshGeneratorOctober::MyVoronoiVertexMeshGenerator()
{
